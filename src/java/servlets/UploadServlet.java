...
public class UploadServlet extends HttpServlet {
    ...
    private String imagesFolder = "C:\\Users\\pupil\\Documents\\NetBeansProjects\\PTVR16\\images";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Part filePart : fileParts) {
            String path = imagesFolder + File.separatorChar + getFileName(filePart);
            ...
            Cover cover = new Cover(name, path);
